...
public class ConnectionControllerUnitTest {
	...
	public void testApproveOrRejectConnection() throws InvalidConnectionIdException {
		...
		Mockito.when(connectionService.approveOrRejectConnection(approveOrRejectConnection, 1L))
				.thenReturn(approveOrRejectConnectionResponse);
		ResponseEntity<ApproveOrRejectConnectionResponse> result = connectionController
				.approveOrRejectConnection(approveOrRejectConnection, 1L);
